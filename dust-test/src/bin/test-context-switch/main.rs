...
// This dependency is needed to pull in the pendsv handler
#[allow(unused)]
use dust_context_switch::PENDSV_HANDLER;
...
#[cfg(feature = "atsamd09")]
const LED0: (usize, usize) = (0, 24);
#[cfg(feature = "atsaml11")]
const LED0: (usize, usize) = (0, 0);
#[cfg(any(feature = "lpc802", feature = "lpc804"))]
const LED0: (usize, usize) = (0, 15);
#[cfg(feature = "lpc810")]
const LED0: (usize, usize) = (0, 1);
#[cfg(feature = "lpc812")]
const LED0: (usize, usize) = (0, 15);
#[cfg(feature = "lpc82x")]
const LED0: (usize, usize) = (0, 15);
...
const LED0: (usize, usize) = (0, 0);
#[cfg(feature = "lpc1114")]
const LED0: (usize, usize) = (0, 9);
#[cfg(feature = "lpc1343")]
const LED0: (usize, usize) = (3, 0);
#[cfg(feature = "stm32f0")]
const LED0: (usize, usize) = (0, 0);
...
fn get_gpio_port() -> gpio::Port<'static> {
    ...
    let (_port_index, bit_index) = LED0;
...
static mut TIME_MS: Wrapping<i32> = Wrapping(0);
...
static mut TASK_PSP: [u32; TASK_COUNT] = [0; TASK_COUNT];

#[no_mangle]
pub unsafe extern "C" fn dust_switch_context(previous_psp: u32) -> u32 {
    // TODO check for undefined behavior
    TASK_PSP[CURRENT_TASK_ID] = previous_psp;
    CURRENT_TASK_ID = NEXT_TASK_ID;
    TASK_PSP[CURRENT_TASK_ID]
}
...
pub fn main() {
    ...
    let delay_ms = Wrapping(500);
    let (_, bit_index) = LED0;

    let mut next_time = get_time_ms();
    loop {
        next_time += delay_ms;
        gpio_port.set_bits(1 << bit_index);
        while get_time_ms() - next_time < Wrapping(0) {}
