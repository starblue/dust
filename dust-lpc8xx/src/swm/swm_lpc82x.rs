//! SWM peripheral unit for LPC82x
//!
...
movable_function!(I2C1_SDA, 9, 1);
movable_function!(I2C1_SCL, 9, 2);
movable_function!(I2C2_SDA, 9, 3);

movable_function!(I2C2_SCL, 10, 0);
movable_function!(I2C3_SDA, 10, 1);
movable_function!(I2C3_SCL, 10, 2);
movable_function!(ADC_PINTRIG0, 10, 3);

movable_function!(ADC_PINTRIG1, 11, 0);
movable_function!(ACMP_O, 11, 1);
...
fixed_pin_function!(VDDCMP, 0, 10);
