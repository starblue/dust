/// SYSCON peripheral unit for LPC84x
///
/// Checked against UM11029 2017-12-08.
...
pub struct Syscon {
    ...
    pub frooscctrl: RW<u32>,
    reserved_0x02c: u32,
    pub frodirectclkuen: RW<u32>,
    reserved_0x034: u32,
    pub sysrststat: RW<u32>,
    reserved_0x03c: u32,
    pub syspllclksel: RW<u32>,
    pub syspllclkuen: RW<u32>,
    pub mainclkpllsel: RW<u32>,
    pub mainclkplluen: RW<u32>,
    pub mainclksel: RW<u32>,
    pub mainclkuen: RW<u32>,
    pub sysahbclkdiv: RW<u32>,
    reserved_0x05c: u32,
    pub captclksel: RW<u32>,
    pub adcclksel: RW<u32>,
    pub adcclkdiv: RW<u32>,
    pub sctclksel: RW<u32>,
    pub sctclkdiv: RW<u32>,
    pub extclksel: RW<u32>,
    reserved_0x078: u32,
    reserved_0x07c: u32,
    pub sysahbclkctrl: [RW<u32>; 2],
    pub presetctrl: [RW<u32>; 2],
    pub uart0clksel: RW<u32>,
    pub uart1clksel: RW<u32>,
    pub uart2clksel: RW<u32>,
    pub uart3clksel: RW<u32>,
    pub uart4clksel: RW<u32>,
    pub i2c0clksel: RW<u32>,
    pub i2c1clksel: RW<u32>,
    pub i2c2clksel: RW<u32>,
    pub i2c3clksel: RW<u32>,
    pub spi0clksel: RW<u32>,
    pub spi1clksel: RW<u32>,
    reserved_0x0bc: u32,
    reserved_0x0c0: u32,
    reserved_0x0c4: u32,
    reserved_0x0c8: u32,
    ...
    pub frg1div: RW<u32>,
    pub frg1mult: RW<u32>,
    pub frg1clksel: RW<u32>,
    reserved_0x0ec: u32,
    pub clkoutsel: RW<u32>,
    pub clkoutdiv: RW<u32>,
    reserved_0x0f8: u32,
    pub exttracecmd: RW<u32>,
    pub pioporcap: [RO<u32>; 2],
    reserved_0x108: [u8; 0x0134 - 0x108],
...
pub const RESET_SPI1: Reset = Reset(0, 12);
pub const RESET_CRC: Reset = Reset(0, 13);
pub const RESET_UART0: Reset = Reset(0, 14);
pub const RESET_UART1: Reset = Reset(0, 15);
pub const RESET_UART2: Reset = Reset(0, 16);
pub const RESET_IOCON: Reset = Reset(0, 18);
pub const RESET_ACMP: Reset = Reset(0, 19);
pub const RESET_GPIO1: Reset = Reset(0, 20);
pub const RESET_I2C1: Reset = Reset(0, 21);
pub const RESET_I2C2: Reset = Reset(0, 22);
pub const RESET_I2C3: Reset = Reset(0, 23);
pub const RESET_ADC: Reset = Reset(0, 24);
pub const RESET_CTIMER0: Reset = Reset(0, 25);
pub const RESET_DAC0: Reset = Reset(0, 27);
pub const RESET_GPIOINT: Reset = Reset(0, 28);
pub const RESET_DMA: Reset = Reset(0, 29);
pub const RESET_UART3: Reset = Reset(0, 30);
pub const RESET_UART4: Reset = Reset(0, 31);

pub const RESET_CAPT: Reset = Reset(1, 0);
pub const RESET_DAC1: Reset = Reset(1, 1);
pub const RESET_FRG0: Reset = Reset(1, 3);
pub const RESET_FRG1: Reset = Reset(1, 4);

pub const PRESETCTRL_RESERVED: [u32; 2] = [0x0402000f, 0xffffffe4];
...
pub const CLOCK_RAM0_1: Clock = Clock(0, 2);
...
pub const CLOCK_GPIO1: Clock = Clock(0, 20);
...
pub const CLOCK_DAC0: Clock = Clock(0, 27);
pub const CLOCK_GPIO_INT: Clock = Clock(0, 28);
pub const CLOCK_DMA: Clock = Clock(0, 29);
pub const CLOCK_UART3: Clock = Clock(0, 30);
pub const CLOCK_UART4: Clock = Clock(0, 31);

pub const CLOCK_CAPT: Clock = Clock(1, 0);
pub const CLOCK_DAC1: Clock = Clock(1, 1);

pub const SYSAHBCLKCTRL_RESERVED: [u32; 2] = [0x00100008, 0xfffffffc];
...
mod test {
    ...
    fn test_syscon() {
        ...
        assert_eq!(address(&syscon.frooscctrl), 0x4004_8028);
        assert_eq!(address(&syscon.frodirectclkuen), 0x4004_8030);
        ...
        assert_eq!(address(&syscon.mainclkpllsel), 0x4004_8048);
        assert_eq!(address(&syscon.mainclkplluen), 0x4004_804c);
        ...
        assert_eq!(address(&syscon.captclksel), 0x4004_8060);
        assert_eq!(address(&syscon.adcclksel), 0x4004_8064);
        assert_eq!(address(&syscon.adcclkdiv), 0x4004_8068);
        assert_eq!(address(&syscon.sctclksel), 0x4004_806c);
        assert_eq!(address(&syscon.sctclkdiv), 0x4004_8070);
        assert_eq!(address(&syscon.extclksel), 0x4004_8074);
        ...
        assert_eq!(address(&syscon.uart2clksel), 0x4004_8098);
        assert_eq!(address(&syscon.uart3clksel), 0x4004_809c);
        assert_eq!(address(&syscon.uart4clksel), 0x4004_80a0);
        assert_eq!(address(&syscon.i2c0clksel), 0x4004_80a4);
        assert_eq!(address(&syscon.i2c1clksel), 0x4004_80a8);
        assert_eq!(address(&syscon.i2c2clksel), 0x4004_80ac);
        assert_eq!(address(&syscon.i2c3clksel), 0x4004_80b0);
        ...
        assert_eq!(address(&syscon.frg1div), 0x4004_80e0);
        assert_eq!(address(&syscon.frg1mult), 0x4004_80e4);
        assert_eq!(address(&syscon.frg1clksel), 0x4004_80e8);
