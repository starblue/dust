/// SYSCON peripheral unit for LPC81x
///
/// Checked against UM11065 2018-04-02.
...
pub const PRESETCTRL_RESERVED: [u32; 1] = [0xffffe000];
...
pub const SYSAHBCLKCTRL_RESERVED: [u32; 1] = [0xfff00000];
