...
pub struct Syscon {
    ...
    pub usbpllctrl: RW<u32>,
    pub usbpllstat: RO<u32>,
    reserved_0x018: [u8; 0x020 - 0x018],
    ...
    pub usbpllclksel: RW<u32>,
    pub usbpllclkuen: RW<u32>,
    reserved_0x048: [u8; 0x070 - 0x050],
    ...
    reserved_0x0a0: [u8; 0x0ac - 0x0a0],
    pub traceclkdiv: RW<u32>,
    pub systickclkdiv: RW<u32>,
    reserved_0x0b4: [u8; 0x0c0 - 0x0b4],
    ...
    reserved_0x158: [u8; 0x200 - 0x158],
    pub startaprp0: RW<u32>,
    pub starterp0: RW<u32>,
    pub startrsrp0clr: WO<u32>,
    pub startsrp0: RO<u32>,
    pub startaprp1: RW<u32>,
    pub starterp1: RW<u32>,
    pub startrsrp1clr: WO<u32>,
    pub startsrp1: RO<u32>,
    reserved_0x220: [u8; 0x230 - 0x220],
...
pub const CLOCK_USB_REG: Clock = Clock(14);
...
mod test {
    ...
    fn test_syscon() {
        ...
        assert_eq!(address(&syscon.usbpllctrl), 0x4004_8010);
        assert_eq!(address(&syscon.usbpllstat), 0x4004_8014);
        ...
        assert_eq!(address(&syscon.usbpllclksel), 0x4004_8048);
        assert_eq!(address(&syscon.usbpllclkuen), 0x4004_804c);
        ...
        assert_eq!(address(&syscon.traceclkdiv), 0x4004_80ac);
        assert_eq!(address(&syscon.systickclkdiv), 0x4004_80b0);
        assert_eq!(address(&syscon.usbclksel), 0x4004_80c0);
        assert_eq!(address(&syscon.usbclkuen), 0x4004_80c4);
        assert_eq!(address(&syscon.usbclkdiv), 0x4004_80c8);
        ...
        assert_eq!(address(&syscon.startaprp1), 0x4004_8210);
        assert_eq!(address(&syscon.starterp1), 0x4004_8214);
        assert_eq!(address(&syscon.startrsrp1clr), 0x4004_8218);
        assert_eq!(address(&syscon.startsrp1), 0x4004_821c);
